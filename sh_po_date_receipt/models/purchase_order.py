...
class Picking(models.Model):
    ...
    scheduled_date = fields.Datetime('Scheduled Date', help="Scheduled time for the first part of the shipment to be processed. Setting manually a value here would set it as expected date for all the stock moves.")
...
class PurchaseOrderLine(models.Model):
    ...
    def _prepare_stock_moves(self, picking):
        ...
        if self.po_date:
            for re in res:
                re['date'] = self.po_date.strftime(DEFAULT_SERVER_DATETIME_FORMAT)
                re['date_expected'] = self.po_date.strftime(DEFAULT_SERVER_DATETIME_FORMAT)
        return res
...
class StockMove(models.Model):
    ...
    date_expected = fields.Datetime(
        'Expected Date',index=True, required=True,
