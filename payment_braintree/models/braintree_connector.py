    ...
    def braintree_exception(function):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                _logger.error("----------------------Braintree Exception=%r", e)
                result['message'] = 'DownForMaintenanceError'
            except TimeoutError as e:
                _logger.error("----------------------Braintree Exception=%r", e)
                result['message'] = 'TimeoutError'
            except braintree.exceptions.forged_query_string_error.ForgedQueryStringError as e:
                _logger.error("----------------------Braintree Exception=%r", e)
                result['message'] = 'ForgedQueryStringError'
