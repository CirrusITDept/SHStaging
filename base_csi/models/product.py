...
class ProductTemplate(models.Model):
    ...
    custom_120v = fields.Integer(string="120 V")
    custom_208v = fields.Integer(string="208 V")
    custom_240v = fields.Integer(string="240 V")
    custom_wattage = fields.Integer(string="Wattage")
