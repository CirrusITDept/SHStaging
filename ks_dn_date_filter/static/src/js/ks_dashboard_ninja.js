odoo.define('ks_dn_raju.ks_dn_raju_dashboard', function(require) {
    "use strict";
...
//            css_grid = $('.o_rtl').length>0 ?
            ...
            this.ks_date_filter_selection_order = ['l_day', 't_week', 't_month', 't_quarter', 't_year', 'n_day',
                ...
                'ls_year', 'l_week', 'l_month', 'l_quarter','l_half', 'l_year','ls_past_until_now', 'ls_pastwithout_now',
